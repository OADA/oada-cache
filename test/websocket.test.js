...
let connectTime = 3 * 1000; // seconds to click through oauth

describe('Test over websockets. no cache.', function() {
  ...
  */
  ...
  it('connect with token. no cache, no websocket', function(done) {
    this.timeout(connectTime);
    oada.connect({
      domain,
      token: 'def',
